...
# `/remove_fsub` command to remove force subscribe settings
...
# `/link` command to save a file and generate a link
...
# `/start` command to retrieve the file using the generated link
